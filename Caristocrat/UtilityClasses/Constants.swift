...
struct Constants{
    ...
    // Old base urls starts
    //    static let BaseURL                                        =    // Live
    //    http://caristocrat.stagingic.com/api/v1/
    //  static let BaseURL      = "http://caristocrat.stagingic.com/api/v1/"
    //    static let BaseURL                                          = Constants.DEBUG_MODE ? "http://10.1.18.138/CaristoCratApp/api/v1/" : "http://caristocrat-dev.stagingic.com/api/v1/"
    // Old base urls end
    
    //static let BaseURL                                          = Constants.DEBUG_MODE ? "http://caristocrat.stagingic.com/api/v1/" : "https://caristocrat.me/admin/api/v1/"
    
    
    static let BaseURL = "http://globalconsultingpk.com/caristocrat/admin.caristocrat.me/api/v1/"
    ...
    static let NATIONALITIES = ["Afghan",
    ...
    static let EVALUATE_NOW = "Do you want to submit your car for evaluation?"
    static let LATER = "LATER"
    static let YES = "YES"
    static let NEW_CAR = "EVALUATE YOUR CAR"//"NEW CAR"
