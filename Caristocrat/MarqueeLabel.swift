...
open class MarqueeLabel: UILabel, CAAnimationDelegate {
    ...
    */
    ...
    private func setup() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(MarqueeLabel.restartLabel), name:
    ...
    private func forwardPropertiesToSublabel() {
        ...
        */
        ...
        sublabel.font = UIFont(name: super.font.getFontWeight().rawValue, size: super.font.pointSize - 5)
